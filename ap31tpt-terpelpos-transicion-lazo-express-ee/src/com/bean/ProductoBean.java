...
public class ProductoBean implements Cloneable {
    ...
    int tiempoReorden;
    float cantidadUnidad;
    int cantidadIngredientes;
    int cantidadImpuestos;
    ...
    int TIPO_PRODUCTO_COMPUESTOS = 25;
    int TIPO_PRODUCTO_PRODUCIDOS = 26;
    ...
    public static ProductoBean fromJson(JsonObject obj, long empresaId) {
        ...
        if (obj.get("plu").isJsonNull()) {
            System.err.println("SIN PLU:" + obj.get("descripcion").getAsString() + " ID: " + obj.get("id").getAsLong());
            NovusUtils.printLn("SIN PLU:" + obj.get("descripcion").getAsString() + " ID: " + obj.get("id").getAsLong());
        }
        ...
        if (obj.get("puede_vender") != null && !obj.get("puede_vender").isJsonNull()) {
            producto.setPuede_vender(obj.get("puede_vender").getAsString().equals("S"));
        } else {
            // TEMPORAL:
            producto.setPuede_vender(true);
        }

        producto.setPuede_comprar(false);

        if (obj.get("ingrediente") != null && !obj.get("ingrediente").isJsonNull()) {
            producto.setIngrediente(obj.get("ingrediente").getAsString().equals("S"));
        }
        producto.setTipo(obj.get("tipo").getAsInt());

        if (producto.getTipo() == NovusConstante.TIPO_PRODUCTO_COMPUESTO
                || producto.getTipo() == NovusConstante.TIPO_PRODUCTO_PRODUCIDOS
                || producto.getTipo() == NovusConstante.TIPO_PRODUCTO_PROMOCION) {
            producto.setCompuesto(true);
        }

        if (obj.get("usa_balanza") != null && !obj.get("usa_balanza").isJsonNull()) {
            producto.setUsa_balanza(obj.get("usa_balanza").getAsString());
        } else {
            producto.setUsa_balanza("N");
        }

        producto.setEstado(obj.get("estado").getAsString());
        if (obj.get("unidades_medida") != null && !obj.get("unidades_medida").isJsonNull()) {
            producto.setUnidades_medida(obj.get("unidades_medida").getAsString());
        }
        if (obj.get("unidades_medida_id") != null && !obj.get("unidades_medida_id").isJsonNull()) {
            producto.setUnidades_medida_id(obj.get("unidades_medida_id").getAsLong());
        }
        if (obj.get("unidades_medida_valor") != null && !obj.get("unidades_medida_valor").isJsonNull()) {
            producto.setUnidades_medida_valor(obj.get("unidades_medida_valor").getAsFloat());
        }
        if (obj.get("unidades_contenido") != null && !obj.get("unidades_contenido").isJsonNull()) {
            producto.setUnidades_contenido(obj.get("unidades_contenido").getAsString());
        }
        if (obj.get("unidades_contenido_id") != null && !obj.get("unidades_contenido_id").isJsonNull()) {
            producto.setUnidades_contenido_id(obj.get("unidades_contenido_id").getAsLong());
        }
        if (obj.get("unidades_contenido_valor") != null && !obj.get("unidades_contenido_valor").isJsonNull()) {
            producto.setUnidades_contenido_valor(obj.get("unidades_contenido_valor").getAsFloat());
        }
        if (obj.get("cantidad_maxima") != null && !obj.get("cantidad_maxima").isJsonNull()) {
            producto.setCantidadMaxima(obj.get("cantidad_maxima").getAsFloat());
        }
        if (obj.get("cantidad_minima") != null && !obj.get("cantidad_minima").isJsonNull()) {
            producto.setCantidadMinima(obj.get("cantidad_minima").getAsFloat());
        }
        if (obj.get("tiempo_reorden") != null && !obj.get("tiempo_reorden").isJsonNull()) {
            producto.setTiempoReorden(obj.get("tiempo_reorden").getAsInt());
        }
        if (obj.get("precio_maximo") != null && !obj.get("precio_maximo").isJsonNull()) {
            producto.setPrecio_maximo(obj.get("precio_maximo").getAsFloat());
        }
        if (obj.get("precio_minimo") != null && !obj.get("precio_minimo").isJsonNull()) {
            producto.setPrecio_minimo(obj.get("precio_minimo").getAsFloat());
        }
        if (obj.get("precio_tipo_limite") != null && !obj.get("precio_tipo_limite").isJsonNull()) {
            producto.setPrecio_tipo_limite(obj.get("precio_tipo_limite").getAsString());
        }
        if (obj.get("precio_flexible") != null && !obj.get("precio_flexible").isJsonNull()) {
        ...
        if (!obj.get("cantidad_ingredientes").isJsonNull()) {
            producto.setCantidadIngredientes(obj.get("cantidad_ingredientes").getAsInt());
        }

        if (!obj.get("cantidad_impuestos").isJsonNull()) {
            producto.setCantidadImpuestos(obj.get("cantidad_impuestos").getAsInt());
        }
        ...
        if (obj.get("categorias") != null && !obj.get("categorias").isJsonNull()) {
            ...
            for (JsonElement elemt : catg) {
                ...
                cat.setGp_id(elemt.getAsJsonObject().get("grupo").getAsLong());
                cat.setUrl_foto("");
        ...
        if (obj.get("identificadores") != null && !obj.get("identificadores").isJsonNull()) {
            ...
            for (JsonElement elemento : obj.get("identificadores").getAsJsonArray()) {
                ...
                cb.setOrigen(elemento.getAsJsonObject().get("origen").getAsString());
        ...
        if (obj.get("impuestos") != null && !obj.get("impuestos").isJsonNull()) {
            producto.setImpuestos(new ArrayList<>());
            for (JsonElement elemento : obj.get("impuestos").getAsJsonArray()) {
                JsonObject json = elemento.getAsJsonObject();
                ImpuestosBean imp = ImpuestosBean.fromJson(json);
                producto.getImpuestos().add(imp);
            }
            producto.setCantidadImpuestos(obj.get("impuestos").getAsJsonArray().size());
        }

        if (obj.get("tipoStore") != null && !obj.get("tipoStore").isJsonNull()) {
            JsonObject atributosJson = new JsonObject();
            atributosJson.addProperty("tipoStore", obj.get("tipoStore").getAsString());
    ...
    public int getCantidadImpuestos() {
        return cantidadImpuestos;
    }

    public void setCantidadImpuestos(int cantidadImpuestos) {
        this.cantidadImpuestos = cantidadImpuestos;
    }
