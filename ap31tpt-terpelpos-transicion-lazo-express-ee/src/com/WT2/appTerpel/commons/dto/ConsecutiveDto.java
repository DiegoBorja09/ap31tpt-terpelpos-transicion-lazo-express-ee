...
public class ConsecutiveDto {
    ...
    private ConsecutiveAtributeDto consecutiveAtributeDto;

    public ConsecutiveAtributeDto getConsecutiveAtributeDto() {
        return consecutiveAtributeDto;
    }

    public void setConsecutiveAtributeDto(ConsecutiveAtributeDto consecutiveAtributeDto) {
        this.consecutiveAtributeDto = consecutiveAtributeDto;
    }
