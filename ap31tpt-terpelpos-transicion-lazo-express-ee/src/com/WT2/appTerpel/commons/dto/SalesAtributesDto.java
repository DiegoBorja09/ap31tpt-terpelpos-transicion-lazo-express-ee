 ...
 * @author USUARIO
 */
public class SalesAtributesDto {
    ...
    private ConsecutiveDto consecutiveDto;
    private SalesAtributeExtraDataDto salesAtributeExtraDataDto;
    ...
    public ConsecutiveDto getConsecutiveDto() {
        return consecutiveDto;
    }

    public void setConsecutiveDto(ConsecutiveDto consecutiveDto) {
        this.consecutiveDto = consecutiveDto;
    }

    public SalesAtributeExtraDataDto getSalesAtributeExtraDataDto() {
        return salesAtributeExtraDataDto;
    }

    public void setSalesAtributeExtraDataDto(SalesAtributeExtraDataDto salesAtributeExtraDataDto) {
        this.salesAtributeExtraDataDto = salesAtributeExtraDataDto;
    }
