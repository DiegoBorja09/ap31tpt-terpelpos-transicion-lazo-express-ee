...
public class CambiarPrecioProgramadoView extends JDialog {
    ...
    public CambiarPrecioProgramadoView(InfoViewController parent, boolean modal) {
        super(parent, modal);
        this.parent = parent;
        initComponents();
        init();
    ...
    void actualizarVista() {
        this.renderizarCambiosProgramados();
    }

    private void renderizarCambiosProgramados() {
        String dateAplicado = "";
        ...
        for (MovimientosDetallesBean producto : this.Productos) {
            ...
            try {
                ...
                try {
                    ...
                    if (producto.getAplicado() != null) {
                        dateAplicado = sdf.format(producto.getAplicado());
                    } else {
                        dateAplicado = " ";
                    }
                ...
                defaultModel.addRow(new Object[]{producto.getId(), producto.getDescripcion(), sdf.format(producto.getFecha()),
                    dateAplicado, producto.getPrecio(), estado
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NRO", "PRODUCTO", "FECHA PROGRAMADO", "FECHA APLICADO", "PRECIO", "ESTADO"
            }
        ) {
        ...
        jLabel3.setText("PROGRAMACION CAMBIO PRECIO");
...
// GEN-LAST:event_jCheckBox1ActionPerformed
    ...
    void solicitarCambios() {
        ...
        try {
            Productos = mdao.CambiosProgramadorInfo();
