...
public class CambiarPrecioHistorialView extends JDialog {
    ...
    public CambiarPrecioHistorialView(InfoViewController parent, boolean modal) {
        super(parent, modal);
        this.parent = parent;
        initComponents();
        init();
    ...
    void actualizarVista() {
        this.renderizarCambiosHistorial();
           ...
           for (MovimientosDetallesBean producto : this.Productos) {
            ...
            try {
                defaultModel.addRow(new Object[] { producto.getId(), sdf.format(producto.getFecha()) ,  producto.getSurtidor(),
                    producto.getCara(), producto.getManguera(),producto.getDescripcion(), producto.getPrecio(), producto.getPrecioN()            
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NRO", "FECHA", "SURTIDOR", "CARA", "MANGUERA", "PRODUCTO", "PRECIO ANTIGUO", "PRECIO ACTUAL"
            }
        ) {
        ...
        jLabel3.setText("HISTORIAL CAMBIOS PRECIO");
        ...
        jLabel6.setBounds(610, 750, 75, 16);
...
//        jComboPromotor.setEnabled(jCheckBox1.isSelected());
    ...
    void SolicitarCambios(){
        ...
        try{
            ...
            Productos = mdao.CambiosHistorialInfo();
