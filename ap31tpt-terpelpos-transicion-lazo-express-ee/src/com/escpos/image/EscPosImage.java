...
public class EscPosImage {
    ...
    public List<ByteArrayOutputStream> getRasterRows(int bitsPerColumn_8_or_24) {
        if (bitsPerColumn_8_or_24 == 8) {
            if (!CashedEscPosRasterRows_8.isEmpty()) {
            ...
            if (!CachedEscPosRasterRows_24.isEmpty()) {
    ...
    /**
     * Call the custom algorithm to determine print or not print on each
     * coordinates.
     * <p>
