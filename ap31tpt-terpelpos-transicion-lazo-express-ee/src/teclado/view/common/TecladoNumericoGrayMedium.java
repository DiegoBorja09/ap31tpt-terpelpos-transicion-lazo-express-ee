 ...
 * @author ASUS-PC
 */
public class TecladoNumericoGrayMedium extends JPanel {

    public static String texto = "";

    ImageIcon botonOn = new ImageIcon(getClass().getResource("/teclado/view/resources/tecladoNumericoGrayMedium/keyNumericGrayMedium.png"));
    ImageIcon botonOff = new ImageIcon(getClass().getResource("/teclado/view/resources/tecladoNumericoGrayMedium/keyNumericGrayMediumPress.png"));

    ImageIcon botonAceptar1 = new ImageIcon(getClass().getResource("/teclado/view/resources/tecladoNumericoGrayMedium/keyNumericGrayMediumOk.png"));
    ImageIcon botonAceptar2 = new ImageIcon(getClass().getResource("/teclado/view/resources/tecladoNumericoGrayMedium/keyNumericGrayMediumOkPress.png"));

    ImageIcon botonBorrar1 = new ImageIcon(getClass().getResource("/teclado/view/resources/tecladoNumericoGrayMedium/keyNumericGrayMediumDelete.png"));
    ImageIcon botonBorrar2 = new ImageIcon(getClass().getResource("/teclado/view/resources/tecladoNumericoGrayMedium/keyNumericGrayMediumDeletePress.png"));

    Robot robot;
    private boolean presiono;

    public TecladoNumericoGrayMedium() {
        initComponents();
        try {
            robot = new Robot();
        } catch (AWTException ex) {
            Logger.getLogger(TecladoNumericoGrayMedium.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        jlabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teclado/view/resources/tecladoNumericoGrayMedium/keyNumericGrayMedium.png"))); // NOI18N
        jlabel1.setText("1");
        ...
        add(jlabel1);
        jlabel1.setBounds(27, 10, 150, 90);

        jlabel2.setFont(new java.awt.Font("Conthrax", 1, 50)); // NOI18N
        jlabel2.setForeground(new java.awt.Color(75, 74, 91));
        jlabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jlabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teclado/view/resources/tecladoNumericoGrayMedium/keyNumericGrayMedium.png"))); // NOI18N
        jlabel2.setText("2");
        ...
        add(jlabel2);
        jlabel2.setBounds(197, 10, 150, 90);

        jlabel3.setFont(new java.awt.Font("Conthrax", 1, 50)); // NOI18N
        jlabel3.setForeground(new java.awt.Color(75, 74, 91));
        jlabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jlabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teclado/view/resources/tecladoNumericoGrayMedium/keyNumericGrayMedium.png"))); // NOI18N
        jlabel3.setText("3");
        ...
        add(jlabel3);
        jlabel3.setBounds(367, 10, 150, 90);

        jlabel6.setFont(new java.awt.Font("Conthrax", 1, 50)); // NOI18N
        jlabel6.setForeground(new java.awt.Color(75, 74, 91));
        jlabel6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jlabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teclado/view/resources/tecladoNumericoGrayMedium/keyNumericGrayMedium.png"))); // NOI18N
        jlabel6.setText("6");
        ...
        add(jlabel6);
        jlabel6.setBounds(367, 106, 150, 80);

        jlabel5.setFont(new java.awt.Font("Conthrax", 1, 50)); // NOI18N
        jlabel5.setForeground(new java.awt.Color(75, 74, 91));
        jlabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jlabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teclado/view/resources/tecladoNumericoGrayMedium/keyNumericGrayMedium.png"))); // NOI18N
        jlabel5.setText("5");
        ...
        add(jlabel5);
        jlabel5.setBounds(197, 106, 150, 80);

        jlabel4.setFont(new java.awt.Font("Conthrax", 1, 50)); // NOI18N
        jlabel4.setForeground(new java.awt.Color(75, 74, 91));
        jlabel4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jlabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teclado/view/resources/tecladoNumericoGrayMedium/keyNumericGrayMedium.png"))); // NOI18N
        jlabel4.setText("4");
        ...
        add(jlabel4);
        jlabel4.setBounds(27, 106, 150, 80);

        jlabel7.setFont(new java.awt.Font("Conthrax", 1, 50)); // NOI18N
        jlabel7.setForeground(new java.awt.Color(75, 74, 91));
        jlabel7.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jlabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teclado/view/resources/tecladoNumericoGrayMedium/keyNumericGrayMedium.png"))); // NOI18N
        jlabel7.setText("7");
        ...
        add(jlabel7);
        jlabel7.setBounds(27, 198, 150, 80);

        jlabel8.setFont(new java.awt.Font("Conthrax", 1, 50)); // NOI18N
        jlabel8.setForeground(new java.awt.Color(75, 74, 91));
        jlabel8.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jlabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teclado/view/resources/tecladoNumericoGrayMedium/keyNumericGrayMedium.png"))); // NOI18N
        jlabel8.setText("8");
        ...
        add(jlabel8);
        jlabel8.setBounds(197, 198, 150, 80);

        jlabel9.setFont(new java.awt.Font("Conthrax", 1, 50)); // NOI18N
        jlabel9.setForeground(new java.awt.Color(75, 74, 91));
        jlabel9.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jlabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teclado/view/resources/tecladoNumericoGrayMedium/keyNumericGrayMedium.png"))); // NOI18N
        jlabel9.setText("9");
        ...
        add(jlabel9);
        jlabel9.setBounds(367, 198, 150, 80);
        ...
        jlabel0.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teclado/view/resources/tecladoNumericoGrayMedium/keyNumericGrayMedium.png"))); // NOI18N
        jlabel0.setText("0");
        ...
        add(jlabel0);
        jlabel0.setBounds(27, 290, 150, 80);

        jlabel10.setFont(new java.awt.Font("Conthrax", 1, 60)); // NOI18N
        jlabel10.setForeground(new java.awt.Color(75, 74, 91));
        jlabel10.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jlabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teclado/view/resources/tecladoNumericoGrayMedium/keyNumericGrayMedium.png"))); // NOI18N
        jlabel10.setText(".");
        ...
        add(jlabel10);
        jlabel10.setBounds(197, 290, 150, 80);
        ...
        jlabelAceptar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teclado/view/resources/tecladoNumericoGrayMedium/keyNumericGrayMediumOk.png"))); // NOI18N
        ...
        add(jlabelAceptar);
        jlabelAceptar.setBounds(17, 382, 510, 70);
        ...
        jlabelBorrar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teclado/view/resources/tecladoNumericoGrayMedium/keyNumericGrayMediumDelete.png"))); // NOI18N
        ...
        add(jlabelBorrar);
        jlabelBorrar.setBounds(362, 290, 160, 80);

        background.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teclado/view/resources/tecladoNumericoGray.png"))); // NOI18N
        background.setToolTipText("");
        add(background);
        background.setBounds(0, 0, 554, 470);
