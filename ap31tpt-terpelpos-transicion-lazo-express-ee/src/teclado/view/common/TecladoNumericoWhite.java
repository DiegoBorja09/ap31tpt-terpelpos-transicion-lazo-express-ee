 ...
 * @author ASUS-PC
 */
public class TecladoNumericoWhite extends JPanel {

    public static String texto = "";

    ImageIcon botonOn = new ImageIcon(getClass().getResource("/teclado/view/resources/teclado_numerico_bt_white.png"));
    ImageIcon botonOff = new ImageIcon(getClass().getResource("/teclado/view/resources/teclado_numerico_bt_off.png"));

    ImageIcon botonAceptar1 = new ImageIcon(getClass().getResource("/teclado/view/resources/btn_aceptar_1.png"));
    ImageIcon botonAceptar2 = new ImageIcon(getClass().getResource("/teclado/view/resources/btn_aceptar_2.png"));

    ImageIcon botonBorrar1 = new ImageIcon(getClass().getResource("/teclado/view/resources/btn_delete.png"));
    ImageIcon botonBorrar2 = new ImageIcon(getClass().getResource("/teclado/view/resources/btn_delete_2.png"));

    Robot robot;
    private boolean presiono;

    public TecladoNumericoWhite() {
        initComponents();
        try {
            robot = new Robot();
        } catch (AWTException ex) {
            Logger.getLogger(TecladoNumericoWhite.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        jlabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teclado/view/resources/teclado_numerico_bt_white.png"))); // NOI18N
        jlabel1.setText("1");
        ...
        jlabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teclado/view/resources/teclado_numerico_bt_white.png"))); // NOI18N
        jlabel2.setText("2");
        ...
        jlabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teclado/view/resources/teclado_numerico_bt_white.png"))); // NOI18N
        jlabel3.setText("3");
        ...
        jlabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teclado/view/resources/teclado_numerico_bt_white.png"))); // NOI18N
        jlabel6.setText("6");
        ...
        jlabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teclado/view/resources/teclado_numerico_bt_white.png"))); // NOI18N
        jlabel5.setText("5");
        ...
        jlabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teclado/view/resources/teclado_numerico_bt_white.png"))); // NOI18N
        jlabel4.setText("4");
        ...
        jlabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teclado/view/resources/teclado_numerico_bt_white.png"))); // NOI18N
        jlabel7.setText("7");
        ...
        jlabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teclado/view/resources/teclado_numerico_bt_white.png"))); // NOI18N
        jlabel8.setText("8");
        ...
        jlabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teclado/view/resources/teclado_numerico_bt_white.png"))); // NOI18N
        jlabel9.setText("9");
        ...
        jlabelAceptar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teclado/view/resources/btn_aceptar_1.png"))); // NOI18N
        ...
        add(jlabelAceptar);
        jlabelAceptar.setBounds(367, 350, 150, 100);
        ...
        jlabel0.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teclado/view/resources/teclado_numerico_bt_white.png"))); // NOI18N
        jlabel0.setText("0");
        ...
        jlabelBorrar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teclado/view/resources/btn_delete.png"))); // NOI18N
        ...
        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teclado/view/resources/teclado_extendido_bg_2.png"))); // NOI18N
