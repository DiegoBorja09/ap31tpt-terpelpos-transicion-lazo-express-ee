 ...
 * @author ASUS-PC
 */
public class TecladoNumericoGray extends JPanel {
    ...
    ImageIcon botonAceptar1 = new ImageIcon(getClass().getResource("/teclado/view/resources/keyNumericOk.png"));
    ImageIcon botonAceptar2 = new ImageIcon(getClass().getResource("/teclado/view/resources/keyNumericOkpress.png"));
    ...
    public TecladoNumericoGray() {
        initComponents();
        try {
            robot = new Robot();
        } catch (AWTException ex) {
            Logger.getLogger(TecladoNumericoGray.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        jlabelAceptar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teclado/view/resources/keyNumericOk.png"))); // NOI18N
